...
selectedCamName = 'cam2';
for indexSubject = 1:length(subjectList)
    convertValue = 1;
    currentSubject = subjectList{indexSubject};
    currentSubjectIndex = 1;
    currentData = dataFull.Treadmill.data;
    currentDataCamIndex = strcmp(currentData.('Camera Name'), selectedCamName);
    currentData = currentData(currentDataCamIndex, :);
...
%                 x = [intialData(currentChannel); x];
              ...
              x = converseData(x+2, convertValue, lookupAmpTable);
